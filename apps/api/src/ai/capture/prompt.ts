...
Output: {"type":"task","title":"Check API issue","body":"Rahul asked me to check the API issue.","url":null,"priority":"medium","dueAt":"<tomorrow>","reminderAt":"<tomorrow at 10:00>","tags":["API"],"recurrence":null,"confidence":"high"}

Input: "Study DSA every day at 7 PM."
Output: {"type":"task","title":"Study DSA","body":null,"url":null,"priority":"medium","dueAt":"<today at 19:00>","reminderAt":null,"tags":[],"recurrence":{"frequency":"daily","weekdays":null,"dayOfMonth":null},"confidence":"high"}

Input: "Review the project every Monday at 10 AM."
Output: {"type":"task","title":"Review the project","body":null,"url":null,"priority":"medium","dueAt":"<next Monday at 10:00>","reminderAt":null,"tags":[],"recurrence":{"frequency":"weekly","weekdays":[1],"dayOfMonth":null},"confidence":"high"}

Input: "Gym Monday Wednesday Friday."
Output: {"type":"task","title":"Gym","body":null,"url":null,"priority":"medium","dueAt":"<next Monday>","reminderAt":null,"tags":[],"recurrence":{"frequency":"weekly","weekdays":[1,3,5],"dayOfMonth":null},"confidence":"high"}

Input: "Pay rent on the first of every month."
Output: {"type":"task","title":"Pay rent","body":null,"url":null,"priority":"high","dueAt":"<first day of next month>","reminderAt":null,"tags":["rent"],"recurrence":{"frequency":"monthly","weekdays":null,"dayOfMonth":1},"confidence":"high"}

Input: "Idea: an app that turns meeting recordings into tasks."
Output: {"type":"idea","title":"App that turns meeting recordings into tasks","body":null,"url":null,"priority":null,"dueAt":null,"reminderAt":null,"tags":["app"],"recurrence":null,"confidence":"high"}

Input: "I need to learn Kubernetes networking."
Output: {"type":"learning","title":"Kubernetes networking","body":null,"url":null,"priority":null,"dueAt":null,"reminderAt":null,"tags":["kubernetes"],"recurrence":null,"confidence":"high"}
...
Output: {"type":"link","title":"Article about RAG","body":null,"url":"https://example.com/rag","priority":null,"dueAt":null,"reminderAt":null,"tags":["article"],"recurrence":null,"confidence":"high"}
`.trim()
